...
public class AutoRed extends LinearOpMode {
    ...
    static final Pose2D TARGET_1 = new Pose2D(DistanceUnit.MM, -1000, -600, AngleUnit.DEGREES, -45); // shooting position
    static final Pose2D TARGET_2 = new Pose2D(DistanceUnit.MM, -1000, -750, AngleUnit.DEGREES, 0);   // correct angle to pick ball
    static final Pose2D TARGET_3 = new Pose2D(DistanceUnit.MM, -200, -700, AngleUnit.DEGREES, 0);    // pos after picking ball
    static final Pose2D TARGET_4 = new Pose2D(DistanceUnit.MM, -50, -900, AngleUnit.DEGREES, 0);          // open gate
    static final Pose2D TARGET_5 = new Pose2D(DistanceUnit.MM, -1000, -600, AngleUnit.DEGREES, -45); // shooting position
    static final Pose2D TARGET_6 = new Pose2D(DistanceUnit.MM, -1000, -1300, AngleUnit.DEGREES, 0);  // pos before intake ball
    static final Pose2D TARGET_7 = new Pose2D(DistanceUnit.MM, -200, -1300, AngleUnit.DEGREES, 0);   // pos after intake ball
    static final Pose2D TARGET_8 = new Pose2D(DistanceUnit.MM, -1000, -600, AngleUnit.DEGREES, -45);
    static final Pose2D TARGET_9 = new Pose2D(DistanceUnit.MM, -1000, -1000, AngleUnit.DEGREES, 0);
    static final Pose2D TARGET_10 = new Pose2D(DistanceUnit.MM, -1000, -1500, AngleUnit.DEGREES, 0);
